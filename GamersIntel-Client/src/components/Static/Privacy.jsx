...
const Privacy = () => {
    ...
    const sections = [
        ...
        {
            icon: <FaUserSecret className="text-4xl text-accent" />,
        ...
        {
            icon: <FaDatabase className="text-4xl text-success" />,
            title: "Data Security",
            content: [
                {
            ...
            <section className="py-20 bg-gradient-to-b from-base-100 via-base-200 to-base-100 relative overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-12">
                        ...
                        <div className="mt-8 inline-block bg-success/10 border border-success/30 rounded-lg px-6 py-3">
                            <p className="text-success font-semibold">Last Updated: January 2026</p>
                        </div>
                    </div>
                </div>
            </section>
                            ...
                            >
                                ...
                                <div className="space-y-6">
                                    {section.content.map((item, idx) => (
                                        <div key={idx} className="border-l-4 border-primary/50 pl-6 hover:border-primary transition-colors duration-300">
                                            <h3 className="text-xl font-bold text-primary mb-2">{item.subtitle}</h3>
                                            <p className="text-base-content/60 leading-relaxed">{item.text}</p>
                                        </div>
                                    ))}
                                </div>
                            </div>
            ...
            <section className="py-20 bg-gradient-to-b from-base-100 via-base-200 to-base-100">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-primary/10 border border-primary/30 rounded-lg p-6 hover:bg-primary/20 hover:scale-105 transition-all duration-300">
                            <div className="flex items-center gap-3 mb-2">
                                <div className="w-3 h-3 bg-primary rounded-full"></div>
                                <h3 className="text-xl font-bold text-base-content">100% Privacy Focused</h3>
                            </div>
                            <p className="text-base-content/60">We never sell your data to anyone, ever.</p>
                        </div>

                        <div className="bg-secondary/10 border border-secondary/30 rounded-lg p-6 hover:bg-secondary/20 hover:scale-105 transition-all duration-300">
                            <div className="flex items-center gap-3 mb-2">
                                <div className="w-3 h-3 bg-secondary rounded-full"></div>
                                <h3 className="text-xl font-bold text-base-content">Your Data, Your Control</h3>
                            </div>
                            <p className="text-base-content/60">Export or delete your data anytime you want.</p>
                        </div>

                        <div className="bg-accent/10 border border-accent/30 rounded-lg p-6 hover:bg-accent/20 hover:scale-105 transition-all duration-300">
                            <div className="flex items-center gap-3 mb-2">
                                <div className="w-3 h-3 bg-accent rounded-full"></div>
                                <h3 className="text-xl font-bold text-base-content">Secure & Encrypted</h3>
                            </div>
                            <p className="text-base-content/60">Industry-standard encryption keeps your data safe.</p>
                        </div>

                        <div className="bg-success/10 border border-success/30 rounded-lg p-6 hover:bg-success/20 hover:scale-105 transition-all duration-300">
                            <div className="flex items-center gap-3 mb-2">
                                <div className="w-3 h-3 bg-success rounded-full"></div>
                                <h3 className="text-xl font-bold text-base-content">Transparent & Honest</h3>
                            </div>
                            <p className="text-base-content/60">No hidden data collection or shady practices.</p>
                        </div>
                    </div>
                </div>
            </section>
